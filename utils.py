...
def build_args():
    ...
    parser.add_argument("--seeds", type=int, nargs="+", default=[0, 0, 0, 0, 0])
    ...
    parser.add_argument("--max_epoch_f", type=int, default=3000)
    parser.add_argument("--lr_f", type=float, default=0.001, help="learning rate for evaluation")
    parser.add_argument("--weight_decay_f", type=float, default=0.0001, help="weight decay for evaluation")
